...
public class SubsystemFactory {
    ...
    public TurretSubsystem CreateTurretSubsystem() {
        ...
        Servo hoodMotor1 = new Servo(Constants.TURRET_HOOD_MOTOR_1);
        Servo hoodMotor2 = new Servo(Constants.TURRET_HOOD_MOTOR_2);
        TurretSubsystem subsystem = new TurretSubsystem(rotateServo, hoodMotor1, hoodMotor2);
