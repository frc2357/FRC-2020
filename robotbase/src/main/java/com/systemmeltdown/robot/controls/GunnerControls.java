    ...
    public static class GunnerControlsBuilder {
        ...
        public GunnerControls build() {
            ...
            if (m_turretSub != null) {
                ...
                m_gunnerControls.m_rightTrigger.whileActiveContinuous(new TrackTargetCommand(m_turretSub, m_visionSubsystem));
                }
            }
            if (m_visionSubsystem != null) {
                m_gunnerControls.m_changePipelineButton.whileHeld(new VisionChangePipelineCommand(m_visionSubsystem));
            }
